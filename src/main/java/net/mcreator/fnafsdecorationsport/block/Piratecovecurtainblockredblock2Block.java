...
public class Piratecovecurtainblockredblock2Block extends Block {
	public Piratecovecurtainblockredblock2Block() {
	...
	public InteractionResult use(BlockState blockstate, Level world, BlockPos pos, Player entity, InteractionHand hand, BlockHitResult hit) {
		...
		Piratecovecurtainblockredblockchange2Procedure.execute(world, x, y, z, entity);
