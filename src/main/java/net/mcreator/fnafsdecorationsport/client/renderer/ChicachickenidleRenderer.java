...
public class ChicachickenidleRenderer extends GeoEntityRenderer<ChicachickenidleEntity> {
	public ChicachickenidleRenderer(EntityRendererProvider.Context renderManager) {
		...
		this.addLayer(new ChicachickenidleLayer(this));
	}

	@Override
	public RenderType getRenderType(ChicachickenidleEntity entity, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
