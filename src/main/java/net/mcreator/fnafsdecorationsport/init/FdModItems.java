...
public class FdModItems {
	...
	public static final RegistryObject<Item> TABLENORTH = block(FdModBlocks.TABLENORTH);
	public static final RegistryObject<Item> TABLESOUTH = block(FdModBlocks.TABLESOUTH);
