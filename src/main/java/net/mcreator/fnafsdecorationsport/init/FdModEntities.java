...
public class FdModEntities {
	...
	public static final RegistryObject<EntityType<ToyfreddyshowtimeEntity>> TOYFREDDYSHOWTIME = register("toyfreddyshowtime",
			EntityType.Builder.<ToyfreddyshowtimeEntity>of(ToyfreddyshowtimeEntity::new, MobCategory.MISC).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(ToyfreddyshowtimeEntity::new)
					...
					.sized(0.6f, 1.8f));
	public static final RegistryObject<EntityType<ToybonnieshowtimeEntity>> TOYBONNIESHOWTIME = register("toybonnieshowtime",
			EntityType.Builder.<ToybonnieshowtimeEntity>of(ToybonnieshowtimeEntity::new, MobCategory.MISC).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(ToybonnieshowtimeEntity::new)

					.sized(0.6f, 1.8f));
	public static final RegistryObject<EntityType<ToyfoxyshowtimeEntity>> TOYFOXYSHOWTIME = register("toyfoxyshowtime",
			EntityType.Builder.<ToyfoxyshowtimeEntity>of(ToyfoxyshowtimeEntity::new, MobCategory.MISC).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(ToyfoxyshowtimeEntity::new)
