...
public class ToychicashowtimeLayer extends GeoLayerRenderer {
	private static final ResourceLocation LAYER = new ResourceLocation("fd", "textures/entities/toy_chica_eyes.png");
	private static final ResourceLocation MODEL = new ResourceLocation("fd", "geo/toy_chica.geo.json");

	public ToychicashowtimeLayer(IGeoRenderer<?> entityRendererIn) {
