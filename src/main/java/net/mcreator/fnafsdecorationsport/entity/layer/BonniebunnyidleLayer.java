...
public class BonniebunnyidleLayer extends GeoLayerRenderer {
	private static final ResourceLocation LAYER = new ResourceLocation("fd", "textures/entities/bonnie_2.png");
	private static final ResourceLocation MODEL = new ResourceLocation("fd", "geo/bonnie_bunny.geo.json");

	public BonniebunnyidleLayer(IGeoRenderer<?> entityRendererIn) {
