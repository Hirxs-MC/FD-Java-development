...
public class ChicachickenidleLayer extends GeoLayerRenderer {
	private static final ResourceLocation LAYER = new ResourceLocation("fd", "textures/entities/chica_2.png");
	private static final ResourceLocation MODEL = new ResourceLocation("fd", "geo/chica_chicken.geo.json");

	public ChicachickenidleLayer(IGeoRenderer<?> entityRendererIn) {
