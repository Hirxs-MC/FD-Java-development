...
public class ToyfreddyshowtimeLayer extends GeoLayerRenderer {
	private static final ResourceLocation LAYER = new ResourceLocation("fd", "textures/entities/toy_freddy_eyes.png");
	private static final ResourceLocation MODEL = new ResourceLocation("fd", "geo/toy_freddy.geo.json");

	public ToyfreddyshowtimeLayer(IGeoRenderer<?> entityRendererIn) {
